...
LLM_int = [
    "/dt/shabtaia/dt-fujitsu/8_bit_attack/Second_submission/experiments/June/inf_0.06274509803921569_0.002_True_6000_4_1_VIT_[[1, 0.0, 0]]_70/"]
PTQ4VIT_paths = [
    "/dt/shabtaia/dt-fujitsu/8_bit_attack/Second_submission/ptq4vit_Quant/experiments/July/inf_0.06274509803921569_0.002_True_3000_1_1_ptq4vit_[[1, 0, 0]]_7000/"]
REP_Q = [
    "/dt/shabtaia/dt-fujitsu/8_bit_attack/Second_submission/RepQ_Quant/experiments/July/inf_0.06274509803921569_0.002_True_3000_1_1_RepQ_[[1, 0, 0]]_7000/"]
No_Quant = [
    "/dt/shabtaia/dt-fujitsu/8_bit_attack/Second_submission/ptq4vit_No_Quant_VIT/experiments/July/inf_0.06274509803921569_0.002_True_100_1_1_ptq4vit_[[1, 0, 0]]_700/"]
ensemble = ["/dt/shabtaia/dt-fujitsu/8_bit_attack/Second_submission/VIT_Quant_ensemble_static/experiments/September/inf_0.06274509803921569_0.002_True_998_4_1_VIT_[[1, 0, 0]]_70/"]
# "/dt/shabtaia/dt-fujitsu/8_bit_attack/Second_submission/VIT_Quant_ensemble_static/experiments/September/inf_0.06274509803921569_0.002_True_1000_4_1_VIT_[[1, 0.0, 0]]_70/"
# "/dt/shabtaia/dt-fujitsu/8_bit_attack/Second_submission/VIT_Quant_ensemble_static/experiments/September/inf_0.06274509803921569_0.002_True_999_4_1_VIT_[[1, 0, 0]]_70/"
# "/dt/shabtaia/dt-fujitsu/8_bit_attack/Second_submission/ptq4vit_Quant_ensemble_static/experiments/September/inf_0.06274509803921569_0.002_True_999_4_1_ptq4vit_[[1, 0, 0]]_70/"
# "/dt/shabtaia/dt-fujitsu/8_bit_attack/Second_submission/VIT_Quant_ensemble_static/experiments/September/inf_0.06274509803921569_0.002_True_998_4_1_VIT_[[1, 0, 0]]_70/"
P = ensemble
...
for i, images_path in enumerate(P):
    ...
    for i, file in enumerate(tqdm(clean_files)):
        ...
        if preprocessor:
            file_clean_defense = torch.tensor(
                preprocessor(torch.load(clean_files[i], map_location=device).detach().cpu().numpy())[0]).to(
                device)  # with defense
            file_adv_defense = torch.tensor(
                preprocessor(torch.load(adv_files[i], map_location=device).detach().cpu().numpy())[0]).to(
                device)  # with defense
