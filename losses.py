...
from utils.init_collect_arrays import input_arr, outliers_arr, outliers_arr_local, all_act, layer_norm_arr
...
class Loss:
    ...
    def loss_gradient(self, x, y, ids=None, loss_type="many_to_many"):
        ...
        #     second = True
        pred, second = self.predict(x_grad, ids)
    ...
    def add_various_losses(self, loss, loss_fn, loss_weight, inputs, targets, x_grad, y, ids, second, pred):
        ...
        if loss_weight[1] != 0:
            ...
            loss += loss_weight[1] * loss_fn(y_tag, true_label).squeeze().mean()
        #
