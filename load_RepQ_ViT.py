...
# from quant import *
from RepQ_ViT.classification.utils import *
from RepQ_ViT.classification.quant import *


def get_args_parser():
    parser = argparse.ArgumentParser(description="RepQ_ViT", add_help=False)
    parser.add_argument("--model", default="deit_base",
                        choices=['vit_small', 'vit_base',
                                 'deit_tiny', 'deit_small', 'deit_base',
                                 'swin_tiny', 'swin_small'],
                        help="model")
    parser.add_argument('--dataset', default="/dt/shabtaia/dt-fujitsu/datasets/others/imagnet/val_in_folders/",
    ...
    parser.add_argument('--w_bits', default=6,
                        type=int, help='bit-precision of weights')
    parser.add_argument('--a_bits', default=6,
...
def get_RepQ_ViT_net():
    parser = argparse.ArgumentParser('RepQ_ViT', parents=[get_args_parser()])
    ...
    load = "/home/barasa/8_bits_attack/RepQ_ViT/classification/weights/model_6bit_base_vit.pth"
    # load = "/home/barasa/8_bits_attack/RepQ_ViT/classification/weights/model_6bit_deit_base_patch16_224.pth"
    ...
    if load:
        q_model.load_state_dict(torch.load(load))
    q_model.to(device)
    # q_model.eval()
    ...
    #            f"/home/barasa/8_bits_attack/RepQ_ViT/classification/weights/model_6bit_{model_zoo[args.model]}.pth")
    return q_model
